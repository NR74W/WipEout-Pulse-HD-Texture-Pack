...
More information at the PPSSPP forum thread : https://forums.ppsspp.org/showthread.php?tid=26335

## How to install
- Download the repository as .zip then extract it to **/ppsspp/memstick/PSP/TEXTURES/***(gameid)*
- Enable **Replace textures** in *Settings > Options > Developer tools*.
